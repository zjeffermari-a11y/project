                ...
                <div className={`mt-5 pt-5 border-t ${theme.borderLight} overflow-x-auto transition-all animate-in fade-in slide-in-from-top-2`}>
                    ...
                    {monitorRoute && (
                        <div className={`mt-4 mb-2 p-4 rounded-xl border border-rose-200 bg-rose-50 flex items-center justify-between`}>
                            ...
                            <Link to={monitorRoute} className="bg-rose-600 text-white px-4 py-2 rounded-lg text-xs font-black uppercase tracking-widest shadow-sm hover:bg-rose-700 transition-colors shrink-0 flex items-center gap-2">
