        ...
        <div id="generated-document" className="bg-white shadow-2xl w-[1200px] min-h-[1500px] px-12 py-12 relative flex flex-col font-serif mx-auto my-10 overflow-x-auto">
            ...
            <table className="text-xs font-bold items-center max-w-3xl mb-6 text-left">
                <tbody>
                    ...
                    <tr><td className="py-1">Audit Engagement No.</td><td className="py-1">:</td><td><input type="text" defaultValue={engagement.ae_number || `AE-${new Date().getFullYear()}-XXX`} className="bg-transparent border-none outline-none w-full font-bold text-black" /></td></tr>
